SHELL_COMMAND = "./Postgres_GroupBy_Sort.sh"
...
base_env = {
  CLASSPATH = table.concat({"${CLASSPATH}", CP, "./master.jar", "./Postgres_GroupBy_Sort.sh"}, ":"),
}
...
operator = yarn {
  ...
  container = {
    ...
    ["Postgres_GroupBy_Sort.sh"] = {
       file = "/opt/npapa/asap-server/asapLibrary/operators/Postgres_GroupBy_Sort/Postgres_GroupBy_Sort.sh",
