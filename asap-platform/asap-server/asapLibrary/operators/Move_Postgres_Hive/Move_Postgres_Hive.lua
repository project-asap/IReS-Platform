...
SHELL_COMMAND = "./Move_Postgres_Hive.sh"
...
base_env = {
  CLASSPATH = table.concat({"${CLASSPATH}", CP, "./master.jar", "./Move_Postgres_Hive.sh"}, ":"),
}
...
operator = yarn {
  ...
  container = {
    ...
    ["Move_Postgres_Hive.sh"] = {
       file = "/opt/npapa/asap-server/asapLibrary/operators/Move_Postgres_Hive/Move_Postgres_Hive.sh",
