...
SHELL_COMMAND = "./HIVE_GroupBy_Sort.sh"
...
base_env = {
  CLASSPATH = table.concat({"${CLASSPATH}", CP, "./master.jar", "./HIVE_GroupBy_Sort.sh"}, ":"),
}
...
operator = yarn {
  ...
  container = {
    ...
    ["HIVE_GroupBy_Sort.sh"] = {
       file = "/opt/npapa/asap-server/asapLibrary/operators/HIVE_GroupBy_Sort/HIVE_GroupBy_Sort.sh",
