...
operator = yarn {
  ...
  container = {
    ...
    resources = {
    ["kmeans_mllib.sh"] = {
       file = "/opt/npapa/asap-server/asapLibrary/operators/kmeans_mllib/kmeans_mllib.sh",
      type = "file",               -- other value: 'archive'
      visibility = "application",  -- other values: 'private', 'public'
	},
    ["spark_kmeans_text.py"] = {
       file = "/opt/npapa/asap-server/asapLibrary/operators/kmeans_mllib/spark_kmeans_text.py",
      type = "file",               -- other value: 'archive'
      visibility = "application",  -- other values: 'private', 'public'
	}
    },
