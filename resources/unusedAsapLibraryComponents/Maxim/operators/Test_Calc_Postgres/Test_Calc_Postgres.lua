SHELL_COMMAND = "./Test_Calc_Postgres.sh"
...
base_env = {
  CLASSPATH = table.concat({"${CLASSPATH}", CP, "./master.jar", "./Test_Calc_Postgres.sh"}, ":"),
}
...
operator = yarn {
  ...
  container = {
    ...
    stageout = {"output"},
    resources = {
    ["Test_Calc_Postgres.sh"] = {
       file = "/opt/asap-server/asapLibrary/operators/Test_Calc_Postgres/Test_Calc_Postgres.sh",
